...
it('should be able to get uploads', async () => {
    ...
    let sut = await getUploads({searchQuery: namePattern, page: 1, pageSize: 3 })
...
it('should be able to get sorted uploads', async () => {
    ...
    let sut = await getUploads({searchQuery: namePattern, sortBy: 'createdAt', sortDirection: 'desc' })
    ...
    let sut = await getUploads({searchQuery: namePattern, sortBy: 'createdAt', sortDirection: 'asc' })
